...
public class Trainer {
	...
	public Trainer(Antigen[] Ag, int Ngen, int N, int M, int d, int n,
			double p, int antibodySize, int antibodyRange, double clonalFactor) {
		this.Ngen = Ngen;
		this.N = N;
		this.M = M;
		this.d = d;
	...
	public static double iris(ArrayList<Antigen> trainSet1, int Ngen, int N, int M, int d, int n, double p,
			int antibodySize, int antibodyRange, double clonalFactor)
			throws IOException {
		...
		for (int k = 0; k < 10; k++) {
			...
			Trainer T = new Trainer(trainData, Ngen, N, M, d, n, p,
					antibodySize, antibodyRange, clonalFactor);
	...
	public static ArrayList<ArrayList<Antigen>> prepareIris() throws IOException{
	...
	public static void main(String... args) throws IOException {
		...
		System.out.println(iris(irisData.get(0), 400, 20, 3, 3, 10, 0.01, 4, 4, 1.0));
		Antigen[] trainData;
		Antigen[] testData;
		...
		Trainer T = new Trainer(trainData,400, 20, 3, 3, 10, 0.01, 4, 4, 1.0);
		Antibody[] Ab = T.train(); // all the work
